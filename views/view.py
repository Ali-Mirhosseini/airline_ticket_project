...
#lable
lable_id = Label(ticket, text = 'ID', font = ('B Titr', 10), bg = 'light blue')
lable_id.place(x = 20,y = 37)

lable_name = Label(ticket, text = 'Name', font = ('B Titr', 10), bg = 'light blue')
lable_name.place(x = 20, y = 77)

lable_family = Label(ticket, text = 'Family', font = ('B Titr', 10), bg = 'light blue')
lable_family.place(x = 20, y = 117)

lable_birthday = Label(ticket, text = 'Birthday', font = ('B Titr', 10), bg = 'light blue')
lable_birthday.place(x = 20, y = 157)

lable_username = Label(ticket, text = 'Username', font = ('B Titr', 10), bg = 'light blue')
lable_username.place(x = 20, y = 197)

lable_password = Label(ticket, text = 'Password', font = ('B Titr', 10), bg = 'light blue')
lable_password.place(x = 20, y = 237)

lable_lock = Label(ticket, text = 'Is_Locked', font = ('B Titr', 10), bg = 'light blue')
lable_lock.place(x = 20, y = 320)

lable_role1 = Label(ticket, text = 'Admin', font = ('B Titr', 10), bg = 'light blue')
lable_role1.place(x = 20, y = 400)

lable_role2 = Label(ticket, text = 'Custome', font = ('B Titr', 10), bg = 'light blue')
...
checkbutton = Checkbutton(ticket, onvalue = True, offvalue = False, bg = 'light blue')
...
radiobutton1 = Radiobutton(ticket, variable = choice, value = '1', bg = 'light blue')
radiobutton2 = Radiobutton(ticket, variable = choice, value = '2', bg = 'light blue')
